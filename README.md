...
[Working Application - Deployed](https://roamify-app.netlify.app/)

- roamify-html - working html/css/javascript project (contains assets)
...
```sh
npx create-react-app@latest roamify-app
```
...
// JSX
<img src={logo} className="nav-logo" alt="roamify" />;
```
